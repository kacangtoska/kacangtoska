    ...
    >
      <div class="row pt-5">
        <div class="col-lg-4 col-md-4 mb-5">
          ...
          <div class="d-flex justify-content-start mt-4">
            <a
              class="btn btn-outline-primary rounded-circle text-center me-2 px-0"
        ...
        <div class="col-lg-4 col-md-4 mb-5">
          ...
          <div class="d-flex flex-column justify-content-start">
            ...
            >
            <a class="text-white mb-2" href="#"
              ><i class="fa fa-angle-right me-2"></i>Our Classes</a
            >
            <a class="text-white mb-2" href="#"
              ><i class="fa fa-angle-right me-2"></i>Our Teachers</a
            >
            <a class="text-white mb-2" href="#"
      ...
      >
        <p class="m-0 text-center text-white">
          &copy;
          <a class="text-primary font-weight-bold" href="{{ route('home') }}">{{ env('APP_NAME') }}</a>.
          All Rights Reserved.
