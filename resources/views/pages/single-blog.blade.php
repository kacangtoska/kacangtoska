        ...
        <div class="col-lg-8">
          <div class="d-flex flex-column text-left mb-3">
            <p class="section-title pe-5">
              <span class="pe-2">Blog Detail Page</span>
            </p>
            <h1 class="mb-3">Diam dolor est ipsum clita lorem</h1>
            <div class="d-flex">
              <p class="me-3"><i class="fa fa-user text-primary"></i> Admin</p>
              <p class="me-3">
                <i class="fa fa-folder text-primary"></i> Web Design
              </p>
              <p class="me-3"><i class="fa fa-comments text-primary"></i> 15</p>
            </div>
          </div>
          <div class="mb-5">
            <img
            ...
            <img
              class="img-fluid rounded w-50 float-right ms-4 mb-3"
              src="img/blog-2.jpg"
              alt="Image"
            />
            <p>
          ...
          <div class="mb-5">
            ...
            <div class="media mb-4">
              <img
                src="img/user.jpg"
                alt="Image"
                class="img-fluid rounded-circle me-3 mt-1"
                style="width: 45px"
              />
